...
from ml_driven_drifter_data_analysis.modeling.fitting_models.linear_regression import select_variables, linear_regression, fit_sigmoid
from prediction_functions import recreate_trajs_LR_sigmoid
...
for i, node in enumerate(datatree.leaves):
    ...
    pred= recreate_trajs_LR_sigmoid(datatree[drifter], dt, days, popt_u, popt_v, fieldsets, time_starts)
