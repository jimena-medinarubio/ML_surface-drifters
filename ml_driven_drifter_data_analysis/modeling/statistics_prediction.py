...
import cartopy.crs as ccrs
sys.path.append("..")
from config import MODELS_DIR, DATA_DIR, INTERIM_DATA_DIR, PROJ_ROOT
...
#%%
dt_pred=xr.open_datatree(f'{INTERIM_DATA_DIR}/predicted_trajectories.nc')
dt_obs=xr.open_datatree(f'{INTERIM_DATA_DIR}/interpolated_atm_ocean_datasets_depth.nc')
