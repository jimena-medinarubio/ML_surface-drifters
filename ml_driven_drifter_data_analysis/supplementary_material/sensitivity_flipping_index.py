...
def sensitivity_analysis_fi_plot(example_drifter, datatree, dict_flipping_index, delta_times, output_path=None, output_format='svg', name_fig='sensitivity_analysis_fi'):
    ...
    zoom_xlim = [5, 6]  # Define the x-limits for the zoom window (adjust these values based on your data)
    ...
    axins = inset_axes(plt.gca(), width="30%", height="40%", loc='upper center')  # Position the zoom window
    ...
    axins.set_ylabel('FI', fontsize=12)
